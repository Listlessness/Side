...
import { CollapsibleParagraph, CustomCarousel, MessageComp, ScrollScreenWrapper, sideStreamWrapper, Thumbnail } from '../../components';
...
type State = AnimeDetailsScreenState<AnimeById>;
type Props = AnimeDetailsScreenProps;

class AnimeDetailsScreenComponent extends PureComponent<Props, State> {
